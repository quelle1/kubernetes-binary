...
docker pull quelle/metrics-scraper:v1.0.4
docker pull quelle/dashboard:v2.0.1
...
docker tag quelle/metrics-scraper:v1.0.4 kubernetesui/metrics-scraper:v1.0.4
docker tag quelle/dashboard:v2.0.1  kubernetesui/dashboard:v2.0.1
