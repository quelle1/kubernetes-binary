...
W1129 23:08:30.380320    4109 version.go:102] falling back to the local client version: v1.18.6
...
kubernetes v1.18.6的镜像，在下载容器`docker pull quelle/kubenetes-download:v1.18.6`时，前面四个都在server里面包含了，只需要下载后面的pause,etcd,coredns，dashboard四个就可以了。
...
docker pull quelle/coredns:1.6.7
docker pull quelle/k8s-dns-kube-dns:1.14.13
docker pull quelle/k8s-dns-dnsmasq-nanny:1.14.13
...
docker tag quelle/coredns:1.6.7 k8s.gcr.io/coredns:1.6.7
docker tag quelle/k8s-dns-kube-dns:1.14.13 k8s.gcr.io/k8s-dns-kube-dns:1.14.13
docker tag quelle/k8s-dns-dnsmasq-nanny:1.14.13 k8s.gcr.io/k8s-dns-dnsmasq-nanny:1.14.13
docker tag quelle/k8s-dns-sidecar:1.14.13 k8s.gcr.io/k8s-dns-sidecar:1.14.13

docker save k8s.gcr.io/k8s-dns-kube-dns:1.14.13 k8s.gcr.io/k8s-dns-dnsmasq-ddnanny:1.14.13 k8s.gcr.io/k8s-dns-sidecar:1.14.13 > k8s-dns-1.14.13.tar
docker save k8s.gcr.io/kubernetes-dashboard-amd64:v1.10.1 > k8s-dashboard-amd64-v1.10.1.tar
docker save  k8s.gcr.io/pause:3.2 k8s.gcr.io/etcd:3.4.3-0  k8s.gcr.io/coredns:1.6.7 > k8s-pause-etcd-coredns-v1.18.6.tar
