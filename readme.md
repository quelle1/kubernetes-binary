...
kubernetes v1.15.4的镜像

kubernetes二进制文件下载及镜像仓库下载；

kubernetes v1.15.4的镜像，在下载容器`docker pull quelle/kubenetes-download:v1.15.4`时，前面四个都在server里面包含了，只需要下载后面的pause,etcd,coredns，dashboard四个就可以了。
